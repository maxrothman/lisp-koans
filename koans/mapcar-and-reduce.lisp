...
(define-test transposition
  ...
  (flet ((transpose (lists) (apply #'mapcar #'list lists)))
    ...
    (let ((newlist-transposed '(("these" "pretzels" "are")
                                ("making" "me" "thirsty" ))))
      (assert-equal newlist-transposed (transpose '(("these" "making")
                                                    ("pretzels" "me")
                                                    ("are" "thirsty")))))))
...
(define-test reduce-from-end
  ...
  (let ((numbers '(1 2 3 4 5)))
    ...
    (assert-equal (list* 1 2 3 4 5) (reduce #'cons numbers :from-end t)))
  (let ((numbers '(2 3 2)))
